function seq_result = iafsa_self_pollination(cur_individual,middle_1,middle_2,Buf)
%% 参数设置
...
%% 减法操作
P1_maker_col = middle_1(:,29); % 父代1的选择序列标记
P2_maker_col = middle_2(:,29); % 父代2的选择序列标记
P_maker_ass = cur_individual(:,29); % 父代1的选择序列标记
[E_a,a_t] = iafsa_subtraction(P1_maker_col,P2_maker_col);% 总装序列次数统计
%% 加法操作
if a_t ~= 0
    t = 1;
    legal_seq = 0;
